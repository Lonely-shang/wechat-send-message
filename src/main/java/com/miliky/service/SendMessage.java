...
public class SendMessage {
    ...
    public void sendMessageByTemplate(String touserStr, String templateId) {
        ...
        try {
            ...
            requestData.put("touser", touserStr);
    ...
    public void sendForbiddenNumberMessageByTemplate(String touserStr, String templateId) {
        ...
        try {
            ...
            JSONObject todayForbiddenNumber = new JSONObject();
            todayForbiddenNumber.put("value", forbiddenNumber.get(0).toString());
            todayForbiddenNumber.put("color", "#005faf");

            JSONObject text = new JSONObject();

            String str = "--------------------\n";
            forbiddenNumber.remove(0);
            for (Limited limited : forbiddenNumber) {
                str += limited.toString();
            }
            text.put("value", str);

            data.put("today", todayForbiddenNumber);
            data.put("text", text);
            requestData.put("data", data);
            RequestBody body = RequestBody.create(mediaType, requestData.toJSONString());
            Request request = new Request.Builder()
